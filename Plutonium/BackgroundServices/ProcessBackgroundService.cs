...
namespace Plutonium.BackgroundServices
{
    public class ProcessBackgroundService : BackgroundService
    {
        ...
        public ProcessBackgroundService(ILogger<ProcessBackgroundService> logger, IOptions<AppConfiguration> appConfiguration, IProcessesService processesService)
        {
            _logger = logger;
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                var matchingProcesses = _processesService.GetMatchingProcesses();
